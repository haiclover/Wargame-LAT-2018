            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/38" method="POST" id="form">
                    ...
                    <div class="card mt-2" >
                        <div class="card-body">
                            <div class="card-text">
                               <kbd><a href="<?php echo base_url() ?>files/level38.php"><?php echo base_url() ?>files/level38.php</a></kbd>
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Đây là một phiên bản khác của loại mã hóa ký tự ra đời vào 1870-1967'>Xem hướng dẫn</button>
                        </div>
                    </div>  
