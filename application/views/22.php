            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/22" method="get" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text" style="user-select: none;">
                                Mật khẩu: <code>LlTB4julNkfbxQL8hixeQvwACf4eaUoXB48PO8W52NMpATfZ</code>
                                <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Nếu chúng ta biết cho đi thì sẽ được nhận lại! '>Xem hướng dẫn</button>
                            </div>
