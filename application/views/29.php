            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/29" method="POST" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <kbd><a href="<?php echo base_url() ?>files/Level29.xlsx"><?php echo base_url() ?>files/Level29.xlsx</a></kbd>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Xem kĩ file excel'>Xem hướng dẫn</button>
                        </div>
                    </div>
