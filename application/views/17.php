            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/17" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                <img src="<?php echo base_url(); ?>files/latpass.png" width="100px" alt="">
                            </div>
                            <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" data-placement="left" title="Hướng Dẫn" data-content="Gợi ý 1 : Tập trung vào bức ảnh mà chúng tôi cung cấp cho bạn!">Hướng dẫn 1</button>
                            <button type="button" class="btn btn-lg btn-warning" data-toggle="popover" data-placement="right" title="Hướng Dẫn" data-content="Gợi ý 2 : Đôi khi to nhỏ cũng ảnh hưởng tới nhiều thứ !">Hướng dẫn 2</button>
                        </div>
                    </div>
