            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/3" method="POST" id="">
                                <h4>Nhập mật khẩu đúng để sang level tiếp theo</h4>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-lock"></i></span></div>
                                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                    <input type="text" class="form-control" name="password" id="password" placeholder="Mật khẩu..." autocomplete="off" disabled="disabled" autofocus required>
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content=" Mật khẩu của Level này là: L.A.T Company">Xem hướng dẫn</button>
                        </div>
                    </div>
