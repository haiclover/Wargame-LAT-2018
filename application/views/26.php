            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/26" method="POST" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                <kbd><a href="<?php echo base_url() ?>files/level26.html"><?php echo base_url() ?>files/level26.html</a></kbd>
                            </div>
                           <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Nằm trong file level26.html'>Xem hướng dẫn</button>
                        </div>
                    </div>
