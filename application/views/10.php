            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/10" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                Mật khẩu sẽ hiện ra khi bạn ấn nó <b>9999</b> lần
                            </div>  
                            <button class="btn btn-success" id="show">Click me now! </button>
                            <div class="alert alert-success mt-3 " hidden="hidden" id="canchange" >
                                Mật khẩu: <span>=MmMlhTMyYDMjNjYhNmM5QWOwQmM0ETYkVzNiZjZ3cTM</span>
                            </div>
