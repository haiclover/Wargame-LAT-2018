            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/15" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                               <a href="<?php echo base_url(); ?>files/15?view=jpg"><img src="<?php echo base_url(); ?>files/pic.jpg" alt="pic 1" width="200px"></a>
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content="Gợi ý : Tập trung vào bức ảnh tôi cung cấp cho bạn">Xem hướng dẫn</button>
                        </div>
                    </div>
