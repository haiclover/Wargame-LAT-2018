            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/6" method="POST" id="">
                                <h4>Nhập mật khẩu đúng để sang level tiếp theo</h4>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-lock"></i></span></div>
                                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                    <input type="number" class="form-control" name="password" id="password" placeholder="Mật khẩu..." autocomplete="off"  autofocus required>
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                Mật khẩu của Level này là: Số thành viên của Hỗ trợ nghiên cứu và học lập trình L.A.T Club là bao nhiêu?
                                Yêu cầu tham gia group để thấy số thành viên thực
                            </div>
                            <a href="https://www.facebook.com/groups/156689748317923" target="_blank" class="btn btn-outline-info">Tham gia ngay!</a>
                        </div>
                    </div>
