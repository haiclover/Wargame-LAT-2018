            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/40" method="POST" id="form">
                    ...
                    <div class="card mt-2" >
                        <div class="card-body">
                            <div class="card-text">
                                <kbd><a href="<?php echo base_url() ?>level40/lv40/index.php">File Level 40</a></kbd>
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Dựa vào trang shell online mà chúng tôi cung cấp cho bạn'>Xem hướng dẫn</button>
                        </div>
                    </div>  
...
<!-- pass login được đặt ở 1 nơi mà khi nào bạn cũng nhìn thấy nó -->