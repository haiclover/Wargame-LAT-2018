            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/23" method="POST" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text" style="user-select: none;">
                                <kbd><a href="<?php echo base_url() ?>files/level23.txt"><?php echo base_url() ?>files/level23.txt</a></kbd>
                                <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Là dạng mã hóa Javascript'>Xem hướng dẫn</button>
                            </div>
