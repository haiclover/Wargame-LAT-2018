            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/24" method="POST" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text" style="user-select: none;">
                                <a href="<?php echo base_url() ?>files/level24.png"><img src="<?php echo base_url() ?>files/level24.png" alt="" width="70px"></a>
                            </div>
                           <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Đây là 1 phần mềm viết bằng C++ ra đời vào 27 năm trước do * * * * * phát triển'>Xem hướng dẫn</button>
                        </div>
                    </div>
...
<script src="<?php echo base_url(); ?>js/prevent.js"></script>
