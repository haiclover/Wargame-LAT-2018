            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/2" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" data-placement="bottom" title='Bạn chỉ cần copy mật khẩu này để qua Level tiếp theo: <?php echo md5(sha1(base64_encode('haiclover'))) ?>'>Xem hướng dẫn</button>
                        </div>
                    </div>
