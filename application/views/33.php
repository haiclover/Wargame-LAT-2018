            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/33" method="POST" id="form">
					...
					<div class="card mt-2" >
						<div class="card-body" style="user-select: none;">
                            <div class="card-text">
                                <a href="https://www.facebook.com/LAT.Co.LTD/" msg="wargame"><img src="<?php echo base_url() ?>files/bot-icon.png" alt="chatbot" width="70px"></a>
                            </div>
							<button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Chatbot đang nắm giữ mật khảu của level này'>Xem hướng dẫn</button>
						</div>
					</div>	
