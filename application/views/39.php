            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/39" method="POST" id="form">
                    ...
                    <div class="card mt-2" >
                        <div class="card-body">
                            <div class="card-text">
                                <kbd><a href="<?php echo base_url() ?>files/lv39.php" target="_blank">lv39.php</a></kbd>
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Đọc và hiểu file mà chúng tôi cung cấp cho bạn'>Xem hướng dẫn</button>
                        </div>
                    </div>  
