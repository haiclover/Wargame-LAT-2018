            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/19" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                <img src="<?php echo base_url(); ?>files/pic2.jpg" alt="Winrar,7zip,..." width="250px">
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý 1 : Nằm trong những thứ chúng tôi đã đưa cho bạn'>Hướng dẫn 1</button>
                            <button type="button" class="btn btn-lg btn-warning mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý 2 : 7Zip,Winrar,...'>Hướng dẫn 2</button>
                        </div>
                    </div>
