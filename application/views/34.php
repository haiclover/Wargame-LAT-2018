            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/34" method="POST" id="form">
					...
					<div class="card mt-2" >
						<div class="card-body" style="user-select: none;">
                            <div class="card-text">
                                <a href="<?php echo base_url(); ?>files/generate.png" msg="wargame"><img src="<?php echo base_url(); ?>files/generate.png" alt="chatbot" width="50px"></a>
                            </div>
							<button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Dựa vào hình ảnh mà chúng tôi cung cấp cho bạn'>Xem hướng dẫn</button>
						</div>
					</div>	
