            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/31" method="POST" id="form">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="card-text">
                                <kbd><a href="<?php echo base_url() ?>files/lv31.php">File Password Level 31</a></kbd>
                            </div>
                            <button type="button" class="btn btn-lg btn-danger mt-2" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Gợi ý :Nằm trong file Level 31'>Xem hướng dẫn</button>
                        </div>
                    </div>
