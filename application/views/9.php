            ...
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url(); ?>Level/submit/9" method="POST" id="">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" data-placement="bottom" title="Hướng Dẫn" data-content='Giải đoạn mã sau bằng điện thoại :94466626444'>Xem hướng dẫn</button>
